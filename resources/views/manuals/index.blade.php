					...
					<table class="data-table table table-striped table-bordered dt-responsive nowrap">
						<thead>
							<tr>
								...
								<th><a href="{{ $sortLinks['role_id']['url'] }}">Rol<i class="fa fa-{{ $sortLinks['role_id']['type'] }}"></i></a></th>					
								<th><a href="{{ $sortLinks['file']['url'] }}">Archivo<i class="fa fa-{{ $sortLinks['file']['type'] }}"></i></a></th>								
								<th >Acciones</th>
							</tr>
						</thead>
						<tbody>
...
@section('footer')	
    ...
    <script src="{{ asset('js/scripts/manuals-controller.js') }}" ></script>
@stop
