...
use App\Repository\DeviationRepository as Repository;
use App\ORM\Deviation as Model;
class DeviationController extends SettingsController
{
    ...
    public function __construct(){
        ...
        $this->classname = Model::class;
         ...
         $this->entityName ="deviation";
        $this->entitiesName ="deviations";
